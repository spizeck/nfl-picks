 ...
 * @param {ESPNCompetitor} competitor ESPN competitor entry.
 * @param {string} state Normalized game state.
 * @param {number|undefined} teamScore This competitor's score.
 * @param {number|undefined} opponentScore Opponent's score.
 * @return {string|undefined} Record entering the game, if reported.
 */
 ...
 * @param {string} summary ESPN record summary such as "2-0" or "1-0-1".
 * @param {string} outcome This team's result in the completed game.
 * @return {string} Record with the game's own result removed.
 */
