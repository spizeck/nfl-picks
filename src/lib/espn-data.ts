...
/**
 * Whether a stored game document differs from freshly normalized ESPN data in
 * a way that should be persisted. Mirrored in functions/src/lib/espn-data.ts
 * for the scheduled score updater.
 *
